...
class ICIMV13WorkflowTests(unittest.TestCase):
    def test_workflow_uses_r7_migration_persistence_and_gmail_gate(self) -> None:
        ...
        self.assertIn("ref: 48929d3b48126cfa6a7435467d031abf4ebc79f0", text)
        ...
        self.assertIn('strategy.BUILD_ID == "v1.3-20260913-r7-grid-half-v1"', text)
        self.assertIn('strategy.GRID_POLICY_REVISION == "ic_im_grid_half_20260913_v1"', text)
