...
class MicrocapWorkflowRefreshGateTests(unittest.TestCase):
    def test_microcap_workflow_refreshes_state_before_signals(self) -> None:
        ...
        self.assertIn('PLANNED_BJ: "16:00 Asia/Shanghai"', text)
        ...
        self.assertIn("title=Microcap refresh heartbeat", refresh_step)
        self.assertIn('tail -n 8 "${attempt_log}"', refresh_step)
        ...
        self.assertIn(r"\[realtime-state\] phase=", refresh_step)
        ...
        self.assertEqual(text.count('ref: c94b623267dad732dfd4499f4a8ff70858b4dd03'), 3)
