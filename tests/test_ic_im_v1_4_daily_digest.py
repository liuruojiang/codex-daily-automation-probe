...
import build_ic_im_v1_4_digest as digest  # noqa: E402
import check_ic_im_v1_4_delivery as gate  # noqa: E402
import prepare_ic_im_v1_4_marker as marker  # noqa: E402
import restore_ic_im_v1_4_ledger as restore  # noqa: E402
...
def signal(product: str) -> dict[str, object]:
    value: dict[str, object] = {
        ...
        "v14_action": "HOLD",
        "v14_action_reason": "state_unchanged",
        "v14_signal_scope": "research_model_signal_only",
    }
    if product == "IC":
        value.update(
...
class ICIMV14DailyDigestTests(unittest.TestCase):
    ...
    def test_digest_names_release_and_explains_new_filters(self) -> None:
        ...
        self.assertIn("IC/IM 1.4-r1", subject)
        self.assertIn("6%防守门槛触发并减半", body)
        self.assertIn("Volume/MA160=0.900", body)
        self.assertIn("IC 1.4规则明确禁止卖Call", body)
