...
class ICIMV14WorkflowTests(unittest.TestCase):
    def test_workflow_uses_r1_migration_persistence_and_gmail_gate(self) -> None:
        ...
        self.assertIn("ref: 42d1dd160a9dc7595f00aaf7c6a6afc96cb38e41", text)
        ...
        self.assertIn('strategy.BUILD_ID == "v1.4-20260928-r1-coreput3x-open-fix7-nocall-repeatroll-iciv30-qdelta05"', text)
        self.assertIn('policy.RULE_REVISION == "ic_im_v1_4_coreput3x_t1_open_20260928_v1"', text)
        ...
        self.assertIn('runner.DELIVERY_REVISION == "20260928-v14-coreput3x-open-fix7-nocall-repeatroll-iciv30-qdelta05"', text)
