...
class ICIMV14WorkflowTests(unittest.TestCase):
    def test_workflow_uses_r1_migration_persistence_and_gmail_gate(self) -> None:
        ...
        self.assertIn("ref: 394d1de398d91b88cf9ff026920ee4747812e12a", text)
        ...
        self.assertIn('strategy.BUILD_ID == "v1.4-20260924-r1-coreput3x-fixedshort95-fix4-integrated-iciv30-qdelta05"', text)
        self.assertIn('policy.RULE_REVISION == "ic_im_v1_4_iciv30_qdelta05_20260918_v1"', text)
        self.assertIn('runner.DELIVERY_REVISION == "20260924-v14-coreput3x-fixedshort95-fix4-integrated-iciv30-qdelta05"', text)
