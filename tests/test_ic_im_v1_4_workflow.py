...
class ICIMV14WorkflowTests(unittest.TestCase):
    def test_workflow_uses_r1_migration_persistence_and_gmail_gate(self) -> None:
        ...
        self.assertIn("ref: 56aa4cc1595f132c7dc391cee370750e07651cff", text)
        ...
        self.assertIn('strategy.BUILD_ID == "v1.4-20260926-r1-coreput3x-fixedshort95-fix6-nocall-repeatroll-iciv30-qdelta05"', text)
        self.assertIn('policy.RULE_REVISION == "ic_im_v1_4_no_im_call_repeat_short_put_roll_20260926_v1"', text)
        ...
        self.assertIn('runner.DELIVERY_REVISION == "20260926-v14-coreput3x-fixedshort95-fix6-nocall-repeatroll-iciv30-qdelta05"', text)
