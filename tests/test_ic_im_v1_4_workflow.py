...
class ICIMV14WorkflowTests(unittest.TestCase):
    def test_workflow_uses_r1_migration_persistence_and_gmail_gate(self) -> None:
        ...
        self.assertIn('strategy.BUILD_ID == "v1.4-20260929-r1-ordinaryput-open-ic-seller-mom120-fix9"', text)
        self.assertIn('policy.RULE_REVISION == "ic_im_v1_4_ordinaryput_open_ic_seller_mom120_20260929_v1"', text)
        ...
        self.assertIn('runner.DELIVERY_REVISION == "20260929-v14-ordinary-put-open-ic-seller-mom120-fix9"', text)
